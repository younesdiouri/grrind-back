...
final class OpenApiContractTest extends KernelTestCase
{
    ...
    public function testTheIdempotentRoutesAreExactlyTheOnesWeExpect(): void
    {
        ...
        self::assertSame(
            ['POST /api/battles', 'POST /api/crafting', 'POST /api/guild/alam/runs', 'POST /api/inventory/chests/{key}/open', 'POST /api/inventory/sales', 'POST /api/shop/purchases', 'POST /api/workouts/import'],
            $idempotent,
