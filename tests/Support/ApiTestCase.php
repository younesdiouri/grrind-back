...
abstract class ApiTestCase extends WebTestCase
{
    ...
    private function truncateEverything(): void
    {
        ...
        $tables = array_filter(
            ...
            static fn (string $table): bool => !\in_array($table, ['doctrine_migration_versions', 'game_activity_type', 'game_discipline', 'game_enemy', 'game_item', 'game_level', 'game_loot_table', 'game_ruleset', 'game_recipe', 'game_settings', 'game_title'], true),
        );
