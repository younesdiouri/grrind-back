    ...
    public static function from(EnemyCatalog $catalog, EnemyTranslator $translator, Fighter $player): self
    {
        return new self(
            FighterResource::from([
                ...
                'comboPermille' => $player->comboPermille,
                'dodgePermille' => $player->dodgePermille,
                'maintenancePermille' => $player->maintenancePermille,
                'criticalChancePermille' => $player->criticalChancePermille,
                'guardPermille' => $player->guardPermille,
                'criticalResistancePermille' => $player->criticalResistancePermille,
                'cooldownReductionPermille' => $player->cooldownReductionPermille,
                'precisionPermille' => $player->precisionPermille,
            ]),
            array_map(
