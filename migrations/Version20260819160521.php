 ...
 * destinataire, catégorie), et le `windowId` qui donne à `AnnounceGuildActivity` un
 * identifiant propre à sa fenêtre plutôt que le seul `authorId` — voir le docblock de
 ...
 *
 * `window_id` en `NOT NULL` sans défaut : la table qu'il rejoint ne contient que des
 * fenêtres d'agrégation en vol, jamais d'historique à préserver — une ligne encore ouverte
 * au moment du déploiement n'a perdu qu'une annonce en attente, pas une donnée de jeu.
 */
